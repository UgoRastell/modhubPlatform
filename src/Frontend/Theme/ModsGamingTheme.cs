...
public static class ModsGamingTheme
{
    ...
    public static MudTheme GetTheme()
    {
        ...
        // Configuration des couleurs via la palette standard
        theme.PaletteDark = new MudBlazor.PaletteDark()
        {
        ...
        // Utiliser la palette correcte sans instanciation directe
        theme.Palette = new MudBlazor.PaletteLight
        {
            // Couleurs principales
            Background = "#1b1f27",
            Surface = "#232634",
